...
contract DeployScript is Script {
    ...
    function readGenesisConfig() public view returns (InitParams memory) {
        ...
        InitParams memory params = InitParams({
            ...
            executionBlockHash: vm.parseJsonBytes32(json, ".executionBlockHash"),
            executionReceiptsRoot: vm.parseJsonBytes32(json, ".executionReceiptsRoot"),
            ...
            executionHeaderVkey: vm.parseJsonBytes32(json, ".executionHeaderVkey"),
